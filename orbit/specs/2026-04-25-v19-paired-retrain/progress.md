...
- [x] ac-05: MADR 0068 superseding 0046 (status: proposed) — orbit/decisions/0068-revisit-gelu-layernorm.md
...
- [ ] ac-09: (post-sweep) At least one architecture passes MADR 0066 gate
- [ ] ac-10: (post-sweep) Three-way diff published
- [ ] ac-11: (post-sweep, conditional on ac-09) Winner promoted
- [ ] ac-12: (post-sweep, conditional on ac-09) CLAUDE.md updated
