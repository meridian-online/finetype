...
**Prior art:**
- `orbit/specs/2026-03-21-sherlock-architecture/spec.yaml` — Original Sherlock architecture spec (AC-1 through AC-10)
- `orbit/specs/2026-03-21-sherlock-architecture/ablation-results.md` — Overnight ablation results
- `orbit/specs/2026-03-20-retraining-spike/findings.md` — Retraining spike proving blend-30-70 optimal
