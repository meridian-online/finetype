...
**Evidence:** Prior collisions audit (orbit/specs/2026-03-26) noted that some types have very few distilled training examples. The distillation pipeline processed 5,364 columns but coverage per type is uneven.
