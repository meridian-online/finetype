...
**Evidence:** `orbit/decisions/0075-mechanism-bucket-coalesce.md:60-66` enumerates the closed cascade. The 4-bucket form discussed at lines 50-56 is the display roll-up; lines 54-56 explicitly say "the trigger label is rule-owned — never inferred from the variant — this keeps the rules and the report column in lock-step." The spec's ac-09 collapses six tokens to four without naming the path suffix policy.
