...
- `orbit/decisions/0084-ac02-floor-empirical-recalibration.md:141-150` — the methodology lesson the bead is meant to honour
...
- `orbit/decisions/0079-triangulator-architecture-for-autonomous-inference.md:92-97` — Phase 1 chose (a) with rationale
- `orbit/decisions/0083-phase-1-signal-scope-lock.md:75-77` — extends weight invariant to 4 signals if Phase 2 ships, but does not pick a discipline
...
- `orbit/decisions/0081-mechanism-vocabulary-aligned-with-madr-0075.md` — vocabulary rules
