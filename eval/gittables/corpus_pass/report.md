...
Total clusters in cell: **2336** (25974 distinct columns affected). Top-10 below cover 7655 columns (29.5% of cell).

##### Rank #1 — `145cb60969d9…` — 1137 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.text.sentence` (conf 0.70) · **cascade** = `format_diversity_path_b` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `data_rate/A00-2018.annv3.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak's parser (Charniak, 2000) to generate …` | `http://dbpedia.org/ontology/sourceText` |
| `data_rate/A00-2018.annv3_10.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak's parser (Charniak, 2000) to generate …` | `http://dbpedia.org/ontology/sourceText` |
| `data_rate/A00-2018.annv3_101.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak's parser (Charniak, 2000) to generate …` | `http://dbpedia.org/ontology/sourceText` |
| `data_rate/A00-2018.annv3_102.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak's parser (Charniak, 2000) to generate …` | `http://dbpedia.org/ontology/sourceText` |
| `data_rate/A00-2018.annv3_108.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak's parser (Charniak, 2000) to generate …` | `http://dbpedia.org/ontology/sourceText` |

##### Rank #2 — `dbd1bc924019…` — 930 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.text.sentence` (conf 0.71) · **cascade** = `format_diversity_path_b` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `data_rate/A00-2018.annv3.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak? s parser (Charniak, 2000) to generate…` | `http://dbpedia.org/ontology/sourceText` |
| `data_rate/A00-2018.annv3_10.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak? s parser (Charniak, 2000) to generate…` | `http://dbpedia.org/ontology/sourceText` |
| `data_rate/A00-2018.annv3_101.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak? s parser (Charniak, 2000) to generate…` | `http://dbpedia.org/ontology/sourceText` |
| `data_rate/A00-2018.annv3_102.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak? s parser (Charniak, 2000) to generate…` | `http://dbpedia.org/ontology/sourceText` |
| `data_rate/A00-2018.annv3_108.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `As a benchmark VPC extraction system, we use the Charniak p…` `Each of these scores can be calculated from a provided synt…` `We then use Charniak? s parser (Charniak, 2000) to generate…` | `http://dbpedia.org/ontology/sourceText` |

##### Rank #3 — `78d8999b25cd…` — 883 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.text.sentence` (conf 0.63) · **cascade** = `format_diversity_path_b` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `processing_time/W99-0623.annv3.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `1 Introduct ion Henderson and Brill (1999) showed that inde…` `the collection of hypotheses ti =fi (Stest) using the unwei…` `5 (Henderson and Brill, 1999) used a similar framework in t…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W99-0623.annv3_1.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `1 Introduct ion Henderson and Brill (1999) showed that inde…` `the collection of hypotheses ti =fi (Stest) using the unwei…` `5 (Henderson and Brill, 1999) used a similar framework in t…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W99-0623.annv3_11.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `1 Introduct ion Henderson and Brill (1999) showed that inde…` `the collection of hypotheses ti =fi (Stest) using the unwei…` `5 (Henderson and Brill, 1999) used a similar framework in t…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W99-0623.annv3_12.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `1 Introduct ion Henderson and Brill (1999) showed that inde…` `the collection of hypotheses ti =fi (Stest) using the unwei…` `5 (Henderson and Brill, 1999) used a similar framework in t…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W99-0623.annv3_16.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `1 Introduct ion Henderson and Brill (1999) showed that inde…` `the collection of hypotheses ti =fi (Stest) using the unwei…` `5 (Henderson and Brill, 1999) used a similar framework in t…` | `http://dbpedia.org/ontology/sourceText` |

##### Rank #4 — `d9d00304b693…` — 881 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.text.sentence` (conf 0.65) · **cascade** = `format_diversity_path_b` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `processing_time/W99-0623.annv3.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Henderson and Brill (1999) showed that independent human re…` `Given a novel sentence Stest E Ctest, combine the collectio…` `(Henderson and Brill, 1999) used a similar framework in the…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W99-0623.annv3_1.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Henderson and Brill (1999) showed that independent human re…` `Given a novel sentence Stest E Ctest, combine the collectio…` `(Henderson and Brill, 1999) used a similar framework in the…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W99-0623.annv3_11.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Henderson and Brill (1999) showed that independent human re…` `Given a novel sentence Stest E Ctest, combine the collectio…` `(Henderson and Brill, 1999) used a similar framework in the…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W99-0623.annv3_12.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Henderson and Brill (1999) showed that independent human re…` `Given a novel sentence Stest E Ctest, combine the collectio…` `(Henderson and Brill, 1999) used a similar framework in the…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W99-0623.annv3_16.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Henderson and Brill (1999) showed that independent human re…` `Given a novel sentence Stest E Ctest, combine the collectio…` `(Henderson and Brill, 1999) used a similar framework in the…` | `http://dbpedia.org/ontology/sourceText` |

##### Rank #5 — `74f0b2a3c42b…` — 651 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.text.sentence` (conf 0.69) · **cascade** = `format_diversity_path_b` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `processing_time/A97-1014.annv3.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `This type of model is used to facilitate the syntactic anno…` `For our experiments, we use the NEGRA corpus (Skut et al, 1…` `As data we use version 2 of the Negra (Skut et al1997) tree…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/A97-1014.annv3.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `This type of model is used to facilitate the syntactic anno…` `For our experiments, we use the NEGRA corpus (Skut et al, 1…` `As data we use version 2 of the Negra (Skut et al1997) tree…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/A97-1014.annv3_1.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `This type of model is used to facilitate the syntactic anno…` `For our experiments, we use the NEGRA corpus (Skut et al, 1…` `As data we use version 2 of the Negra (Skut et al1997) tree…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/A97-1014.annv3_1.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `This type of model is used to facilitate the syntactic anno…` `For our experiments, we use the NEGRA corpus (Skut et al, 1…` `As data we use version 2 of the Negra (Skut et al1997) tree…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/A97-1014.annv3_10.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `This type of model is used to facilitate the syntactic anno…` `For our experiments, we use the NEGRA corpus (Skut et al, 1…` `As data we use version 2 of the Negra (Skut et al1997) tree…` | `http://dbpedia.org/ontology/sourceText` |

##### Rank #6 — `65a052be6ed9…` — 649 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.text.sentence` (conf 0.66) · **cascade** = `format_diversity_path_b` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `bits_per_second/W11-2123_3.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation? Moses (K…` `The language model was com piled into KenLM probing format …` `Thus given afragment tf consisting of a sequence of target …` | `http://dbpedia.org/ontology/sourceText` |
| `bits_per_second/W11-2123_6.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation? Moses (K…` `The language model was com piled into KenLM probing format …` `Thus given afragment tf consisting of a sequence of target …` | `http://dbpedia.org/ontology/sourceText` |
| `bits_per_second/W11-2123_9.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation? Moses (K…` `The language model was com piled into KenLM probing format …` `Thus given afragment tf consisting of a sequence of target …` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W11-2123.annv3_1.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation? Moses (K…` `The language model was com piled into KenLM probing format …` `Thus given afragment tf consisting of a sequence of target …` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W11-2123.annv3_10.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation? Moses (K…` `The language model was com piled into KenLM probing format …` `Thus given afragment tf consisting of a sequence of target …` | `http://dbpedia.org/ontology/sourceText` |

##### Rank #7 — `84f2c1950602…` — 648 columns — action: `model_retrain`
...
| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `bits_per_second/W11-2123_3.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation Moses (Ko…` `The language model was compiled into KenLM probing format (…` `Thus given a fragment tf consisting of a sequence of target…` | `http://dbpedia.org/ontology/sourceText` |
| `bits_per_second/W11-2123_6.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation Moses (Ko…` `The language model was compiled into KenLM probing format (…` `Thus given a fragment tf consisting of a sequence of target…` | `http://dbpedia.org/ontology/sourceText` |
| `bits_per_second/W11-2123_9.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation Moses (Ko…` `The language model was compiled into KenLM probing format (…` `Thus given a fragment tf consisting of a sequence of target…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W11-2123.annv3_1.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation Moses (Ko…` `The language model was compiled into KenLM probing format (…` `Thus given a fragment tf consisting of a sequence of target…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/W11-2123.annv3_10.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `We used common tools for phrase-based translation Moses (Ko…` `The language model was compiled into KenLM probing format (…` `Thus given a fragment tf consisting of a sequence of target…` | `http://dbpedia.org/ontology/sourceText` |

##### Rank #8 — `94f632fc277b…` — 636 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.text.sentence` (conf 0.61) · **cascade** = `format_diversity_path_b` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `processing_time/P08-1102.annv3.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004 )andJiang et al (2008), we…` `plates called lexical-target in the column below areintrodu…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/P08-1102.annv3_1.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004 )andJiang et al (2008), we…` `plates called lexical-target in the column below areintrodu…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/P08-1102.annv3_10.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004 )andJiang et al (2008), we…` `plates called lexical-target in the column below areintrodu…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/P08-1102.annv3_13.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004 )andJiang et al (2008), we…` `plates called lexical-target in the column below areintrodu…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/P08-1102.annv3_14.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004 )andJiang et al (2008), we…` `plates called lexical-target in the column below areintrodu…` | `http://dbpedia.org/ontology/sourceText` |

##### Rank #9 — `2453f1112c2b…` — 631 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.text.sentence` (conf 0.62) · **cascade** = `format_diversity_path_b` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `processing_time/P08-1102.annv3.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004) and Jiang et al (2008), w…` `plates called lexical-target in the column below are introd…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/P08-1102.annv3_1.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004) and Jiang et al (2008), w…` `plates called lexical-target in the column below are introd…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/P08-1102.annv3_10.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004) and Jiang et al (2008), w…` `plates called lexical-target in the column below are introd…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/P08-1102.annv3_13.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004) and Jiang et al (2008), w…` `plates called lexical-target in the column below are introd…` | `http://dbpedia.org/ontology/sourceText` |
| `processing_time/P08-1102.annv3_14.parquet` | `Citation Text Clean` | `representation.text.plain_text` | `representation.text.sentence` | `Following Jiang et al (2008), we describe segmentation and …` `As described in Ng and Low (2004) and Jiang et al (2008), w…` `plates called lexical-target in the column below are introd…` | `http://dbpedia.org/ontology/sourceText` |

##### Rank #10 — `b6b293adbe8e…` — 609 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.text.sentence` (conf 0.58) · **cascade** = `format_diversity_path_b` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `whole/P08-1028.annv3.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Mitchell and Lapata (2008) propose a framework to represent…` `While works such asthe SDSM model suffer from the problem o…` `Mitchell and Lapata (2008), henceforth M& amp; L, propose a…` | `http://dbpedia.org/ontology/sourceText` |
| `whole/P08-1028.annv3_10.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Mitchell and Lapata (2008) propose a framework to represent…` `While works such asthe SDSM model suffer from the problem o…` `Mitchell and Lapata (2008), henceforth M& amp; L, propose a…` | `http://dbpedia.org/ontology/sourceText` |
| `whole/P08-1028.annv3_100.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Mitchell and Lapata (2008) propose a framework to represent…` `While works such asthe SDSM model suffer from the problem o…` `Mitchell and Lapata (2008), henceforth M& amp; L, propose a…` | `http://dbpedia.org/ontology/sourceText` |
| `whole/P08-1028.annv3_101.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Mitchell and Lapata (2008) propose a framework to represent…` `While works such asthe SDSM model suffer from the problem o…` `Mitchell and Lapata (2008), henceforth M& amp; L, propose a…` | `http://dbpedia.org/ontology/sourceText` |
| `whole/P08-1028.annv3_102.parquet` | `Citation Text` | `representation.text.plain_text` | `representation.text.sentence` | `Mitchell and Lapata (2008) propose a framework to represent…` `While works such asthe SDSM model suffer from the problem o…` `Mitchell and Lapata (2008), henceforth M& amp; L, propose a…` | `http://dbpedia.org/ontology/sourceText` |
...
Total clusters in cell: **8** (29 distinct columns affected). Top-8 below cover 29 columns (100.0% of cell).

##### Rank #1 — `2453b24e2e5e…` — 15 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.text.plain_text` (conf 0.55) · **cascade** = `format_diversity_path_a` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_
...
##### Rank #2 — `b0b02a9b5c00…` — 4 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.discrete.categorical` (conf 0.82) · **cascade** = `format_diversity_path_a` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `time_interval/participant603keysequencedata_2020-01-15-14_00_01_1.parquet` | `KeyCode` | `identity.person.gender_code` | `representation.discrete.categorical` | `X` `C` `B` | `http://dbpedia.org/ontology/code` |
| `time_interval/participant603keysequencedata_2020-01-15-14_00_01_2.parquet` | `KeyCode` | `identity.person.gender_code` | `representation.discrete.categorical` | `X` `C` `B` | `http://dbpedia.org/ontology/code` |
| `running_time/participant603keysequencedata_2020-01-15-14_00_01.parquet` | `KeyCode` | `identity.person.gender_code` | `representation.discrete.categorical` | `X` `C` `B` | `http://dbpedia.org/ontology/code` |
| `running_time/participant603keysequencedata_2020-01-15-14_00_01_1.parquet` | `KeyCode` | `identity.person.gender_code` | `representation.discrete.categorical` | `X` `C` `B` | `http://dbpedia.org/ontology/code` |

##### Rank #3 — `4488cceb1d97…` — 3 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.numeric.integer_number` (conf 0.63) · **cascade** = `format_diversity_path_a` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/schedule_items_1.parquet` | `ed_year` | `datetime.component.year` | `representation.numeric.integer_number` | `0` `0` `0` | `http://dbpedia.org/ontology/year` |
| `id/schedule_items_1.parquet` | `st_year` | `datetime.component.year` | `representation.numeric.integer_number` | `0` `0` `0` | `http://dbpedia.org/ontology/year` |
| `id/variable.parquet` | `survey_year` | `datetime.component.year` | `representation.numeric.integer_number` | `0` `0` `0` | `http://dbpedia.org/ontology/year` |

##### Rank #4 — `51c8907164b5…` — 2 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.discrete.categorical` (conf 0.55) · **cascade** = `format_diversity_path_a` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `parent/ldl-ottawa_Monolingual%20ManyBabies%20Individual%20Lab%20Participants%20Data.parquet` | `sib2_gender` | `identity.person.gender_code` | `representation.discrete.categorical` | `M` `NC` | `` |
| `parent/ldl-ottawa_Monolingual%20ManyBabies%20Individual%20Lab%20Participants%20Data.parquet` | `sib3_gender` | `identity.person.gender_code` | `representation.discrete.categorical` | `M` `NC` | `` |

##### Rank #5 — `7925dc9e13e9…` — 2 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.text.entity_name` (conf 0.70) · **cascade** = `format_diversity_path_a` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/payment_intent_data_1.parquet` | `customer_id` | `representation.identifier.alphanumeric_id` | `representation.text.entity_name` | `cus_I0JJf8lbCaJBZS` `cus_I0JJf8lbCaJBZS` `cus_I0JJf8lbCaJBZS` | `http://dbpedia.org/ontology/id` |
| `id/payment_intent_data_3.parquet` | `customer_id` | `representation.identifier.alphanumeric_id` | `representation.text.entity_name` | `cus_I0JJf8lbCaJBZS` `cus_I0JJf8lbCaJBZS` `cus_I0JJf8lbCaJBZS` | `http://dbpedia.org/ontology/id` |

##### Rank #6 — `291cf1c1cd5f…` — 1 columns — action: `validator_widening`
...
| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `quick_time/java11.parquet` | `bug id` | `representation.identifier.alphanumeric_id` | `representation.text.plain_text` | `https://bugs.openjdk.java.net/browse/JDK-8218463` `b/180542784` | `http://dbpedia.org/ontology/id` |

##### Rank #7 — `443ad58c4dea…` — 1 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.discrete.categorical` (conf 0.57) · **cascade** = `format_diversity_path_a` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/field_level_data_Silvia_Castro_Actinidia_deliciosa_Portugal_2018.parquet` | `site_id` | `representation.identifier.alphanumeric_id` | `representation.discrete.categorical` | `A1` `C2` `H` | `http://dbpedia.org/ontology/wikiPageID` |

##### Rank #8 — `cd8ec93a4780…` — 1 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.numeric.decimal_number` (conf 0.84) · **cascade** = `format_diversity_path_a` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_
...
Total clusters in cell: **1** (2 distinct columns affected). Top-1 below cover 2 columns (100.0% of cell).

##### Rank #1 — `839ed8e4221b…` — 2 columns — action: `model_retrain`

- **Corroborating lenses**: **ydf** = `representation.discrete.categorical` (conf 0.61) · **cascade** = `code_vs_canonical_path_a` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/dna_filt.parquet` | `atom_id` | `representation.identifier.alphanumeric_id` | `representation.discrete.categorical` | `C1'` `C2` `C2'` | `http://dbpedia.org/ontology/id` |
| `id/dna_full.parquet` | `atom_id` | `representation.identifier.alphanumeric_id` | `representation.discrete.categorical` | `C1'` `C2` `C2'` | `http://dbpedia.org/ontology/id` |
...
Total clusters in cell: **381** (1365 distinct columns affected). Top-10 below cover 536 columns (39.3% of cell).

##### Rank #1 — `bc0accfe943d…` — 212 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.numeric.decimal_number` (conf 0.50) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/Orobella_1.parquet` | `year` | `datetime.component.year` | `representation.numeric.decimal_number` | `1837.0` `1880.0` | `http://dbpedia.org/ontology/year` |
| `id/Othonnopsis.parquet` | `year` | `datetime.component.year` | `representation.numeric.decimal_number` | `1890.0` | `http://dbpedia.org/ontology/year` |
| `id/Otoptera.parquet` | `year` | `datetime.component.year` | `representation.numeric.decimal_number` | `1852.0` `1837.0` | `http://dbpedia.org/ontology/year` |
| `id/Ouvirandra_1.parquet` | `year` | `datetime.component.year` | `representation.numeric.decimal_number` | `1806.0` `1821.0` `1816.0` | `http://dbpedia.org/ontology/year` |
| `id/Oxiphoeria.parquet` | `year` | `datetime.component.year` | `representation.numeric.decimal_number` | `1811.0` `1805.0` | `http://dbpedia.org/ontology/year` |

##### Rank #2 — `ff0f59031ea3…` — 76 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `geography.address.full_address` (conf 0.76) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/IMPORT_ASSETS_104.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `1122 Megan Squares Suite 848 Port Jason, OR 55475` `5159 Tom Roads Suite 330 Davebury, WY 22846` `23098 Anthony Roads New Maria, MO 12498` | `http://dbpedia.org/ontology/address` |
| `id/IMPORT_ASSETS_105.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `1122 Megan Squares Suite 848 Port Jason, OR 55475` `5159 Tom Roads Suite 330 Davebury, WY 22846` `23098 Anthony Roads New Maria, MO 12498` | `http://dbpedia.org/ontology/address` |
| `id/IMPORT_ASSETS_107.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `1122 Megan Squares Suite 848 Port Jason, OR 55475` `5159 Tom Roads Suite 330 Davebury, WY 22846` `23098 Anthony Roads New Maria, MO 12498` | `http://dbpedia.org/ontology/address` |
| `id/IMPORT_ASSETS_11.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `1122 Megan Squares Suite 848 Port Jason, OR 55475` `5159 Tom Roads Suite 330 Davebury, WY 22846` `23098 Anthony Roads New Maria, MO 12498` | `http://dbpedia.org/ontology/address` |
| `id/IMPORT_ASSETS_110.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `1122 Megan Squares Suite 848 Port Jason, OR 55475` `5159 Tom Roads Suite 330 Davebury, WY 22846` `23098 Anthony Roads New Maria, MO 12498` | `http://dbpedia.org/ontology/address` |

##### Rank #3 — `3308bca5bf31…` — 60 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.boolean.binary` (conf 1.00) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `parent/spRecords.parquet` | `gender` | `identity.person.gender` | `representation.boolean.binary` | `1` `0` `1` | `http://dbpedia.org/ontology/gender` |
| `parent/spRecords_1.parquet` | `gender` | `identity.person.gender` | `representation.boolean.binary` | `1` `0` `1` | `http://dbpedia.org/ontology/gender` |
| `parent/spRecords_12.parquet` | `gender` | `identity.person.gender` | `representation.boolean.binary` | `1` `0` `1` | `http://dbpedia.org/ontology/gender` |
| `parent/spRecords_5.parquet` | `gender` | `identity.person.gender` | `representation.boolean.binary` | `1` `0` `1` | `http://dbpedia.org/ontology/gender` |
| `parent/spRecords_7.parquet` | `gender` | `identity.person.gender` | `representation.boolean.binary` | `1` `0` `1` | `http://dbpedia.org/ontology/gender` |

##### Rank #4 — `e0f77ac4f0dd…` — 41 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `geography.address.full_address` (conf 0.77) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/Selkirk_Client_imp_tpl.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `1965 Kelly Field Apt. 094 Jonesberg, FL 05565` `848 Melissa Springs Suite 947 Kellerstad, MD 80819` `30413 Norton Isle Suite 012 North Lisa, ND 79428` | `http://dbpedia.org/ontology/address` |
| `id/polynesie-museums.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `1965 Kelly Field Apt. 094 Jonesberg, FL 05565` `848 Melissa Springs Suite 947 Kellerstad, MD 80819` `30413 Norton Isle Suite 012 North Lisa, ND 79428` | `http://dbpedia.org/ontology/address` |
| `id/res.bank_548.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `1965 Kelly Field Apt. 094 Jonesberg, FL 05565` `848 Melissa Springs Suite 947 Kellerstad, MD 80819` `30413 Norton Isle Suite 012 North Lisa, ND 79428` | `http://dbpedia.org/ontology/address` |
| `id/res.bank_557.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `1965 Kelly Field Apt. 094 Jonesberg, FL 05565` `848 Melissa Springs Suite 947 Kellerstad, MD 80819` `30413 Norton Isle Suite 012 North Lisa, ND 79428` | `http://dbpedia.org/ontology/address` |
| `id/res.bank_569.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `1965 Kelly Field Apt. 094 Jonesberg, FL 05565` `848 Melissa Springs Suite 947 Kellerstad, MD 80819` `30413 Norton Isle Suite 012 North Lisa, ND 79428` | `http://dbpedia.org/ontology/address` |

##### Rank #5 — `58be7c0351fd…` — 39 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `identity.person.gender_code` (conf 0.69) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `lead_time/cenlab-index_1.parquet` | `gender` | `identity.person.gender` | `identity.person.gender_code` | `f` `f` `m` | `http://dbpedia.org/ontology/gender` |
| `lead_time/cenlab-index_7.parquet` | `gender` | `identity.person.gender` | `identity.person.gender_code` | `f` `f` `m` | `http://dbpedia.org/ontology/gender` |
| `whole/CNPRC_only_exome_available.parquet` | `gender` | `identity.person.gender` | `identity.person.gender_code` | `f` `f` `f` | `http://dbpedia.org/ontology/gender` |
| `whole/ONPRC_sequence_data.parquet` | `gender` | `identity.person.gender` | `identity.person.gender_code` | `f` `f` `f` | `http://dbpedia.org/ontology/gender` |
| `whole/TNPRC_males_wholegenome.parquet` | `gender` | `identity.person.gender` | `identity.person.gender_code` | `m` `m` `m` | `http://dbpedia.org/ontology/gender` |

##### Rank #6 — `6ab6b7b57d00…` — 25 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `geography.address.full_address` (conf 0.60) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/base_partner_104.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `471 Erika Curve North Megan, UT 71358` `339 Riley Mission Suite 515 South Brendamouth, ID 32356` `35256 Craig Drive Apt. 098 North Davidborough, OK 16189` | `http://dbpedia.org/ontology/address` |
| `id/base_partner_11.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `471 Erika Curve North Megan, UT 71358` `339 Riley Mission Suite 515 South Brendamouth, ID 32356` `35256 Craig Drive Apt. 098 North Davidborough, OK 16189` | `http://dbpedia.org/ontology/address` |
| `id/base_partner_12.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `471 Erika Curve North Megan, UT 71358` `339 Riley Mission Suite 515 South Brendamouth, ID 32356` `35256 Craig Drive Apt. 098 North Davidborough, OK 16189` | `http://dbpedia.org/ontology/address` |
| `id/base_partner_23.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `471 Erika Curve North Megan, UT 71358` `339 Riley Mission Suite 515 South Brendamouth, ID 32356` `35256 Craig Drive Apt. 098 North Davidborough, OK 16189` | `http://dbpedia.org/ontology/address` |
| `id/base_partner_31.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `471 Erika Curve North Megan, UT 71358` `339 Riley Mission Suite 515 South Brendamouth, ID 32356` `35256 Craig Drive Apt. 098 North Davidborough, OK 16189` | `http://dbpedia.org/ontology/address` |

##### Rank #7 — `8560ea037d41…` — 23 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `representation.numeric.integer_number` (conf 0.73) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/Test_SetDiversionAggregateFromList_CULocations_out_Collections_1.parquet` | `YEAR` | `datetime.component.year` | `representation.numeric.integer_number` | `0` `0` `0` | `http://dbpedia.org/ontology/year` |
| `id/Test_SetDiversionAggregate_CULocations_out_Collections.parquet` | `YEAR` | `datetime.component.year` | `representation.numeric.integer_number` | `0` `0` `0` | `http://dbpedia.org/ontology/year` |
| `id/Test_SetDiversionAggregate_Diversions_out_Collections.parquet` | `YEAR` | `datetime.component.year` | `representation.numeric.integer_number` | `0` `0` `0` | `http://dbpedia.org/ontology/year` |
| `id/Test_SetDiversionMultiStruct_Diversions_out_Collections.parquet` | `YEAR` | `datetime.component.year` | `representation.numeric.integer_number` | `0` `0` `0` | `http://dbpedia.org/ontology/year` |
| `id/Test_SetDiversionSystemFromList_CULocations_out_Collections.parquet` | `YEAR` | `datetime.component.year` | `representation.numeric.integer_number` | `0` `0` `0` | `http://dbpedia.org/ontology/year` |

##### Rank #8 — `4c202fdc1025…` — 22 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `geography.address.full_address` (conf 0.78) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/Parties_People.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `80160 Clayton Isle Apt. 513 East Linda, ND 59217` `714 Mann Plaza Suite 839 Seanfurt, OK 32234` `09471 Erika Curve North Megan, UT 71358` | `http://dbpedia.org/ontology/address` |
| `id/Parties_People_1.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `80160 Clayton Isle Apt. 513 East Linda, ND 59217` `714 Mann Plaza Suite 839 Seanfurt, OK 32234` `09471 Erika Curve North Megan, UT 71358` | `http://dbpedia.org/ontology/address` |
| `processing_time/Updated-phd.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `80160 Clayton Isle Apt. 513 East Linda, ND 59217` `714 Mann Plaza Suite 839 Seanfurt, OK 32234` `09471 Erika Curve North Megan, UT 71358` | `http://dbpedia.org/ontology/address` |
| `processing_time/btech.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `80160 Clayton Isle Apt. 513 East Linda, ND 59217` `714 Mann Plaza Suite 839 Seanfurt, OK 32234` `09471 Erika Curve North Megan, UT 71358` | `http://dbpedia.org/ontology/address` |
| `processing_time/phd_2.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `80160 Clayton Isle Apt. 513 East Linda, ND 59217` `714 Mann Plaza Suite 839 Seanfurt, OK 32234` `09471 Erika Curve North Megan, UT 71358` | `http://dbpedia.org/ontology/address` |

##### Rank #9 — `1a14cf20f4fa…` — 19 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `geography.address.full_address` (conf 0.71) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `shiva/Jan-22,2020_06_41_06_AMdistlists.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `6118 Wells Ville Suite 171 Simmonsport, WA 90561` `PSC 2961, Box 1133 APO AE 50939` `847 Kramer Station Apt. 615 West Brenda, NE 25659` | `http://dbpedia.org/ontology/address` |
| `shiva/Jan-22,2020_06_41_44_AMdistlists.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `6118 Wells Ville Suite 171 Simmonsport, WA 90561` `PSC 2961, Box 1133 APO AE 50939` `847 Kramer Station Apt. 615 West Brenda, NE 25659` | `http://dbpedia.org/ontology/address` |
| `shiva/Jan-22,2020_06_43_07_AMdistlists.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `6118 Wells Ville Suite 171 Simmonsport, WA 90561` `PSC 2961, Box 1133 APO AE 50939` `847 Kramer Station Apt. 615 West Brenda, NE 25659` | `http://dbpedia.org/ontology/address` |
| `shiva/Jan-22,2020_06_43_55_AMdistlists.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `6118 Wells Ville Suite 171 Simmonsport, WA 90561` `PSC 2961, Box 1133 APO AE 50939` `847 Kramer Station Apt. 615 West Brenda, NE 25659` | `http://dbpedia.org/ontology/address` |
| `shiva/Jan-22,2020_06_46_19_AMdistlists.parquet` | `Email` | `identity.person.email` | `geography.address.full_address` | `6118 Wells Ville Suite 171 Simmonsport, WA 90561` `PSC 2961, Box 1133 APO AE 50939` `847 Kramer Station Apt. 615 West Brenda, NE 25659` | `http://dbpedia.org/ontology/address` |

##### Rank #10 — `8b5fe38b8e85…` — 19 columns — action: `validator_widening`

- **Corroborating lenses**: **ydf** = `geography.address.full_address` (conf 0.55) · **cascade** = `validator_widening` (conf 1.00)
- **Candidate spec slug**: _(none — to be assigned downstream)_

| file | column | sense | ydf | samples | dbpedia |
|---|---|---|---|---|---|
| `id/crm_lead_16.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `6029 Phillip Squares Apt. 264 Yangberg, NE 39564` `75806 Smith Stream Scottstad, NJ 12435` `USS Hill FPO AP 79871` | `http://dbpedia.org/ontology/address` |
| `id/crm_lead_17.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `6029 Phillip Squares Apt. 264 Yangberg, NE 39564` `75806 Smith Stream Scottstad, NJ 12435` `USS Hill FPO AP 79871` | `http://dbpedia.org/ontology/address` |
| `id/crm_lead_19.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `6029 Phillip Squares Apt. 264 Yangberg, NE 39564` `75806 Smith Stream Scottstad, NJ 12435` `USS Hill FPO AP 79871` | `http://dbpedia.org/ontology/address` |
| `id/crm_lead_20.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `6029 Phillip Squares Apt. 264 Yangberg, NE 39564` `75806 Smith Stream Scottstad, NJ 12435` `USS Hill FPO AP 79871` | `http://dbpedia.org/ontology/address` |
| `id/crm_lead_23.parquet` | `email` | `identity.person.email` | `geography.address.full_address` | `6029 Phillip Squares Apt. 264 Yangberg, NE 39564` `75806 Smith Stream Scottstad, NJ 12435` `USS Hill FPO AP 79871` | `http://dbpedia.org/ontology/address` |
