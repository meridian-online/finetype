...
- Prior incident: `decisions/0049-preserve-synthetic-for-bad-distilled-types.md`
  (eval env-var bug, `FINETYPE_MODEL_DIR` vs `FINETYPE_MODEL`)
- Baseline capture: `specs/2026-04-20-distilled-data-relabel-7-types/v16-baseline.md` (ac-10)
