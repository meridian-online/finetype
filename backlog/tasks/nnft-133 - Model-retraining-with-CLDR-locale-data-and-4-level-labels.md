---
id: NNFT-133
title: Model retraining with CLDR locale data and 4-level labels
status: To Do
assignee: []
...
- NNFT-126: 4-level locale labels
...
This task tracks the strategic direction. Actual implementation through NNFT-058, NNFT-060, and NNFT-126.
...
- [ ] #3 CharCNN models retrained with 4-level locale labels (NNFT-126)
- [ ] #4 SOTAB and GitTables re-evaluated showing measurable improvement over v0.3.0 baseline
<!-- AC:END -->
