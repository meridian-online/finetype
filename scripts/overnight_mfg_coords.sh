...
LOG="output/mining-factory/coord-only/train.log"

exec > >(tee -a "$LOG") 2>&1

echo "================================================================"
echo " coord-only candidate train — 3 ReLU seeds, v19 recipe"
echo " FTMB:   $FTMB_FILE"
...
for seed in "${SEEDS[@]}"; do
    name="sherlock-mfg-coords-relu-s${seed}"
...
for seed in "${SEEDS[@]}"; do
    echo "  models/sherlock-mfg-coords-relu-s${seed}"
done
echo "================================================================"
