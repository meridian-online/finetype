...
#
# Spec: 2026-04-20-distilled-data-relabel-7-types (v1.3)
...
#
# ───────────────────────────────────────────────────────────────────
# v18 RETRAIN BLOCK (spec: 2026-04-21-eval-expansion, ac-13)
# ───────────────────────────────────────────────────────────────────
...
# checked off in spec 2026-04-21-eval-expansion (progress.md).
# ───────────────────────────────────────────────────────────────────
set -euo pipefail
...
echo "  v16 baseline pinned in spec 2026-04-20-distilled-data-relabel-7-types (v16-baseline.md)"
echo ""
