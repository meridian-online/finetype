...
- `specs/2026-04-18-v16-data-audit-retrain/training-audit.md` — per-row triage of ~38 mislabeled distilled rows
- `specs/2026-04-20-v16-n1-email-regression/interview.md` — bundled fix target
- `specs/2026-04-20-v16-release/handover.md` — v0.6.17 shipped with narrow email regression
...
`specs/2026-04-18-v16-data-audit-retrain/eval-audit.md`."
...
(`specs/2026-04-20-v16-n1-email-regression/`) with a proper
