...
**Spec:** `specs/2026-04-20-distilled-data-relabel-7-types/spec.yaml`
...
**Description:** ac-11 L186–190 lists four verification steps (`cargo metadata`, `git tag -l`, GH release page, Homebrew formula). Per `specs/2026-04-20-v16-release/handover.md` these are all CI-automated on tag push. The AC is fine but the "verification" list reads as if a human were to check each manually; in practice the release skill / CI handles all four.
