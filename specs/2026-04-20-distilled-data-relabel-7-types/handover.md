...
Full trail in `progress.md`; decision in `decisions/0054-hold-v17-no-promotion.md`.
...
Essential (read in order):
  decisions/0054-hold-v17-no-promotion.md
  specs/2026-04-20-distilled-data-relabel-7-types/progress.md (§Day 3 log)
  specs/2026-04-20-distilled-data-relabel-7-types/spec.yaml (context only)

Supporting (skim if touched):
  decisions/0050-per-type-sourcing-policy.md
  decisions/0051-http-method-enum-only.md
  decisions/0052-scope-aware-eval-gate.md
  decisions/0053-training-gate-88-floor.md
