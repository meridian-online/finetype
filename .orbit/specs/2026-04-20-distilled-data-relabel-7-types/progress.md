...
- **ac-08** — `.orbit/choices/0049-preserve-synthetic-for-bad-distilled-types.md` amended in place. Frontmatter HTML comment + "Update 2026-04-20 — v17 layers distilled data on top" section. Per-type treatments documented. Status `accepted`.
...
**No-promote decision (ac-12, ac-13 on HOLD)** — Documented in `.orbit/choices/0054-hold-v17-no-promotion.md`.
