...
Full trail in `progress.md`; decision in `.orbit/choices/0054-hold-v17-no-promotion.md`.
...
Essential (read in order):
  .orbit/choices/0054-hold-v17-no-promotion.md
...
Supporting (skim if touched):
  .orbit/choices/0050-per-type-sourcing-policy.md
  .orbit/choices/0051-http-method-enum-only.md
  .orbit/choices/0052-scope-aware-eval-gate.md
  .orbit/choices/0053-training-gate-88-floor.md
