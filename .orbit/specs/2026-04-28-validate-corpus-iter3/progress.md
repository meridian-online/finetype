...
- `.orbit/choices/00NN-mechanism-bucket-coalesce.md` — NEW MADR
- `.orbit/choices/00NN-validate-corpus-fixture-anti-regression-lock.md` — NEW MADR
- `.orbit/choices/00NN-label-only-code-canonical-attribution.md` — NEW MADR
