...
- `.orbit/choices/0075-mechanism-bucket-coalesce.md` — established 4-bucket / 6-trigger cascade for `validate-corpus` mechanism attribution; cascade takes (predicted, expected, samples) → mechanism
- `.orbit/choices/0078-validator-alternations-compose-canonical-sibling-patterns.md` — composition-over-invention doctrine; validators are canonical pattern source
