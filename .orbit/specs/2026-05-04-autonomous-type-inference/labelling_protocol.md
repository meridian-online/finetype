...
- `.orbit/choices/0075-mechanism-bucket-coalesce.md` (mechanism vocabulary source)
- `.orbit/choices/0081-mechanism-vocabulary-aligned-with-madr-0075.md` (extended vocabulary)
- `.orbit/choices/0082-fallback-policy-text-string-vs-unknown.md` (fallback semantics)
