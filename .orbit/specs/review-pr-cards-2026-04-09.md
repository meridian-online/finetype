...
`.orbit/cards/0001-type-taxonomy.yaml` line 10:
```yaml
...
`.orbit/cards/0001-type-taxonomy.yaml` has two counts that disagree:
...
- `.orbit/cards/0011-agent-ready-skills.yaml`: all 3 scenarios cite `agent-ready.mdx`
- `.orbit/cards/0012-pii-detection.yaml`: all 3 scenarios cite `schema.mdx`
...
`.orbit/cards/0005-schema-driven-data-validation.yaml` scenario "Separate valid from invalid with SQL" has:
```yaml
