...
`.orbit/choices/0054-hold-v17-no-promotion.md` partly because 5 of 7 relabel
...
- `.orbit/choices/0050-per-type-sourcing-policy.md` — per-type
  synthetic/distilled/real sourcing rules already exist.
- `.orbit/choices/0052-scope-aware-eval-gate.md` — eval gate already
  distinguishes target types from non-targets.
- `.orbit/choices/0049-preserve-synthetic-for-bad-distilled-types.md` — the 7
