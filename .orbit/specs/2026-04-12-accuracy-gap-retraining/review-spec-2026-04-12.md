...
The spec prescribes `lr=1e-3, weight_decay=0.01` citing "Autoresearch: weight_decay=0.01, lr=1e-3 validated on base architecture." This is misleading. The autoresearch spec (`.orbit/specs/2026-04-11-candle-autoresearch-port/spec.yaml` ac-09, ac-11) validated these hyperparameters exclusively on GELU+LN architecture. The actual baseline model (v4-sibling, which achieved 193/227) was trained with `lr=1e-4, weight_decay=1e-4` -- a 10x difference in both parameters.
