...
**Predictions:** `output/ceiling-and-rules-discovery/predictions_v19.tsv`  
...
| datetime.timestamp.sql_standard | 11 | 5 | 3 | 6 | 0.625 (0.31-0.86) | 0.455 (0.21-0.72) |
...
| representation.text.RESIDUAL | 129 | 62 | 10 | 67 | 0.861 (0.76-0.92) | 0.481 (0.40-0.57) |
| representation.text.entity_name | 8 | 6 | 7 | 2 | 0.462 (0.23-0.71) | 0.750 (0.41-0.93) |
...
**Macro precision** (mean over labels): 0.783  
**Macro recall** (mean over labels): 0.793  
