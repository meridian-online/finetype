# Gold eval anchor — v19-nosibling-reframe
...
**Predictions:** `output/ceiling-and-rules-discovery/predictions_v19_nosibling.tsv`  
...
| llm:datetime.offset.utc | 28 | 0.643 |
...
| llm:representation.discrete.categorical | 43 | 0.442 |
...
| tier2:datetime.component.year | 12 | 0.750 |
...
| tier2:identity.commerce.isbn | 29 | 0.828 |
...
| datetime.epoch.unix_seconds | 15 | 9 | 1 | 6 | 0.900 (0.60-0.98) | 0.600 (0.36-0.80) |
| datetime.offset.iana | 4 | 4 | 0 | 0 | 1.000 (0.51-1.00) | 1.000 (0.51-1.00) |
| datetime.offset.utc | 1 | 1 | 4 | 0 | 0.200 (0.04-0.62) | 1.000 (0.21-1.00) |
| datetime.timestamp.dmy_hm | 1 | 1 | 2 | 0 | 0.333 (0.06-0.79) | 1.000 (0.21-1.00) |
| datetime.timestamp.iso_8601_milliseconds | 1 | 1 | 2 | 0 | 0.333 (0.06-0.79) | 1.000 (0.21-1.00) |
| datetime.timestamp.sql_standard | 11 | 5 | 1 | 6 | 0.833 (0.44-0.97) | 0.455 (0.21-0.72) |
...
| geography.location.country | 11 | 9 | 3 | 2 | 0.750 (0.47-0.91) | 0.818 (0.52-0.95) |
| geography.location.country_code | 54 | 49 | 4 | 5 | 0.925 (0.82-0.97) | 0.907 (0.80-0.96) |
...
| representation.identifier.alphanumeric_id | 62 | 41 | 3 | 21 | 0.932 (0.82-0.98) | 0.661 (0.54-0.77) |
...
| representation.numeric.decimal_number | 94 | 75 | 7 | 19 | 0.915 (0.83-0.96) | 0.798 (0.71-0.87) |
| representation.numeric.integer_number | 194 | 162 | 3 | 32 | 0.982 (0.95-0.99) | 0.835 (0.78-0.88) |
| representation.text.RESIDUAL | 129 | 61 | 9 | 68 | 0.871 (0.77-0.93) | 0.473 (0.39-0.56) |
| representation.text.entity_name | 8 | 6 | 10 | 2 | 0.375 (0.18-0.61) | 0.750 (0.41-0.93) |
...
**Headline — column accuracy:** 735/927 = 0.793 (95% CI 0.766-0.818)  
**Macro precision** (mean over labels): 0.788  
**Macro recall** (mean over labels): 0.788  
