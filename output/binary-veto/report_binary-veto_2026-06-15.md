# Gold eval anchor — binary-veto

**Date:** 2026-06-15  
**Gold fixture:** `eval/gold/gold_corpus_v1.tsv` (931 columns)  
**Predictions:** `output/binary-veto/predictions_binary-veto.tsv`  
...
| backbone:representation.numeric.integer_number | 21 | 0.952 |
...
| tier1:datetime.offset.utc | 35 | 0.657 |
...
| representation.numeric.integer_number | 196 | 154 | 1 | 42 | 0.994 (0.96-1.00) | 0.786 (0.72-0.84) |
...
**Macro precision** (mean over labels): 0.720  
**Macro recall** (mean over labels): 0.818  
