# Gold eval anchor — w3-batch-reframe
...
**Predictions:** `output/company-reference-audit/eval_w3_batch/predictions_w3-batch.tsv`  
...
**Headline — column accuracy:** 843/986 = 0.855 (95% CI 0.832-0.876)  

**Production accuracy — production (representative):** 184/260 = 0.708 (95% CI 0.650-0.760)  
...
**Macro precision** (mean over labels): 0.860  
