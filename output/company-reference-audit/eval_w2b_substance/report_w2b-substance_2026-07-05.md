# Gold eval anchor — w2b-substance

**Date:** 2026-07-05  
**Gold fixture:** `eval/gold/gold_corpus.tsv` (986 columns)  
**Scoring mode:** legacy (categorical is a competing label)  
**Predictions:** `output/company-reference-audit/eval_w2b_substance/predictions_w2b-substance.tsv`  
...
| representation.text.plain_text | 39 | 16 | 7 | 23 | 0.696 (0.49-0.84) | 0.410 (0.27-0.57) |
| representation.text.word | 107 | 78 | 6 | 29 | 0.929 (0.85-0.97) | 0.729 (0.64-0.80) |
...
**Headline — column accuracy:** 846/986 = 0.858 (95% CI 0.835-0.878)  

**Macro precision** (mean over labels): 0.864  
**Macro recall** (mean over labels): 0.817  
