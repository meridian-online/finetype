# Gold eval anchor — w2a-membership-reframe
...
**Predictions:** `output/company-reference-audit/eval_w2a_membership/predictions_w2a-membership.tsv`  
...
| representation.text.RESIDUAL | 120 | 80 | 10 | 40 | 0.889 (0.81-0.94) | 0.667 (0.58-0.74) |
...
**Headline — column accuracy:** 807/931 = 0.867 (95% CI 0.843-0.887)  

**Production accuracy — production (representative):** 183/260 = 0.704 (95% CI 0.646-0.756)  
...
**Macro precision** (mean over labels): 0.873  
