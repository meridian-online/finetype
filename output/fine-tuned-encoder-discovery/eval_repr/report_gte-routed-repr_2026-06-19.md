# Gold eval anchor — gte-routed-repr
...
**Predictions:** `output/fine-tuned-encoder-discovery/routed_repr.tsv`  
...
| representation.text.RESIDUAL | 76 | 34 | 5 | 42 | 0.872 (0.73-0.94) | 0.447 (0.34-0.56) |
| representation.text.entity_name | 2 | 1 | 24 | 1 | 0.040 (0.01-0.20) | 0.500 (0.09-0.91) |
...
**Headline — column accuracy:** 164/259 = 0.633 (95% CI 0.573-0.690)  
**Macro precision** (mean over labels): 0.815  
**Macro recall** (mean over labels): 0.611  
