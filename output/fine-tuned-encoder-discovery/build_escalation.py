...
Xtr_t,ytr=load("output/fine-tuned-encoder-discovery/encoder_train_region.tsv","text","label")
...
fams=clf.predict(emb)
override={esc[k]: FAM2LABEL[fams[k]] for k in range(len(esc))}
