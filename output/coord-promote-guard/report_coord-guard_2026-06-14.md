# Gold eval anchor — coord-guard

**Date:** 2026-06-14  
**Gold fixture:** `eval/gold/gold_corpus_v1.tsv` (931 columns)  
**Predictions:** `output/coord-promote-guard/predictions_coord_guard.tsv`  
...
| C_lat_lon_temperature | 90 | 0.978 |
...
| geography.coordinate.latitude | 39 | 38 | 1 | 1 | 0.974 (0.87-1.00) | 0.974 (0.87-1.00) |
| geography.coordinate.longitude | 45 | 42 | 0 | 3 | 1.000 (0.92-1.00) | 0.933 (0.82-0.98) |
...
| representation.numeric.decimal_number | 97 | 83 | 6 | 14 | 0.933 (0.86-0.97) | 0.856 (0.77-0.91) |
...
**Headline — column accuracy:** 666/931 = 0.715 (95% CI 0.686-0.743)  
**Macro precision** (mean over labels): 0.670  
