# Gold eval anchor — cksum-guard-repr
...
**Predictions:** `output/attneg-retrain/cksum_predictions_repr.tsv`  
...
| representation.numeric.integer_number | 69 | 64 | 18 | 5 | 0.780 (0.68-0.86) | 0.928 (0.84-0.97) |
...
**Macro precision** (mean over labels): 0.892  
