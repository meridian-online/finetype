# Gold eval anchor — trim-attneg2-s44

**Date:** 2026-07-07  
**Gold fixture:** `eval/gold/gold_corpus.tsv` (988 columns)  
**Scoring mode:** ENUM REFRAME (categorical/word/plain_text = one text residual)  
**Predictions:** `output/attneg-retrain/trim_predictions_attneg2-s44.tsv`  
**Scored:** 988 columns (0 gold columns had no prediction)  
...
| backbone:representation.text.plain_text | 7 | 0.857 |
| compref:compound_codes | 3 | 0.333 |
| compref:entity_name_check | 1 | 0.000 |
| compref:gleif | 13 | 0.692 |
| compref:iata_boundary | 4 | 0.500 |
| compref:icao_boundary | 7 | 1.000 |
| compref:icd10 | 2 | 1.000 |
| compref:naics | 2 | 0.500 |
| compref:org_person_boundary | 8 | 1.000 |
| compref:s_expression | 1 | 1.000 |
| compref:sec_edgar | 3 | 0.667 |
| compref:user_agent_boundary | 6 | 1.000 |
...
| llm:datetime.component.year | 9 | 0.667 |
...
| llm:geography.coordinate.longitude | 32 | 0.812 |
| llm:geography.location.city | 33 | 0.939 |
| llm:geography.location.country_code | 31 | 0.903 |
| llm:geography.location.region | 35 | 0.800 |
...
| tier1:geography.location.country_code | 13 | 0.846 |
...
|---------------|--------:|---:|---:|---:|-------------------:|----------------:|
| container.array.semicolon_separated | 3 | 0 | 0 | 3 | n/a (n/a) | 0.000 (0.00-0.56) |
| container.object.csv | 1 | 0 | 0 | 1 | n/a (n/a) | 0.000 (0.00-0.79) |
| container.object.s_expression | 1 | 1 | 0 | 0 | 1.000 (0.21-1.00) | 1.000 (0.21-1.00) |
...
| datetime.epoch.unix_seconds | 15 | 12 | 1 | 3 | 0.923 (0.67-0.99) | 0.800 (0.55-0.93) |
| datetime.offset.iana | 3 | 3 | 0 | 0 | 1.000 (0.44-1.00) | 1.000 (0.44-1.00) |
| datetime.offset.timezone_abbreviation | 6 | 6 | 1 | 0 | 0.857 (0.49-0.97) | 1.000 (0.61-1.00) |
...
| geography.address.postal_code | 5 | 5 | 1 | 0 | 0.833 (0.44-0.97) | 1.000 (0.57-1.00) |
...
| geography.location.city | 25 | 25 | 6 | 0 | 0.806 (0.64-0.91) | 1.000 (0.87-1.00) |
| geography.location.continent | 1 | 1 | 0 | 0 | 1.000 (0.21-1.00) | 1.000 (0.21-1.00) |
| geography.location.country | 11 | 10 | 3 | 1 | 0.769 (0.50-0.92) | 0.909 (0.62-0.98) |
| geography.location.country_code | 56 | 54 | 2 | 2 | 0.964 (0.88-0.99) | 0.964 (0.88-0.99) |
| geography.location.region | 15 | 12 | 6 | 3 | 0.667 (0.44-0.84) | 0.800 (0.55-0.93) |
| geography.location.state_code | 8 | 7 | 4 | 1 | 0.636 (0.35-0.85) | 0.875 (0.53-0.98) |
...
| identity.medical.icd10 | 2 | 2 | 0 | 0 | 1.000 (0.34-1.00) | 1.000 (0.34-1.00) |
| identity.person.full_name | 7 | 6 | 0 | 1 | 1.000 (0.61-1.00) | 0.857 (0.49-0.97) |
...
| representation.identifier.alphanumeric_id | 63 | 42 | 1 | 21 | 0.977 (0.88-1.00) | 0.667 (0.54-0.77) |
| representation.identifier.increment | 1 | 1 | 6 | 0 | 0.143 (0.03-0.51) | 1.000 (0.21-1.00) |
| representation.identifier.numeric_code | 4 | 3 | 0 | 1 | 1.000 (0.44-1.00) | 0.750 (0.30-0.95) |
| representation.identifier.uuid | 2 | 2 | 0 | 0 | 1.000 (0.34-1.00) | 1.000 (0.34-1.00) |
| representation.numeric.decimal_number | 95 | 87 | 7 | 8 | 0.926 (0.85-0.96) | 0.916 (0.84-0.96) |
| representation.numeric.integer_number | 192 | 171 | 4 | 21 | 0.977 (0.94-0.99) | 0.891 (0.84-0.93) |
| representation.text.RESIDUAL | 146 | 101 | 26 | 45 | 0.795 (0.72-0.86) | 0.692 (0.61-0.76) |
| representation.text.entity_name | 16 | 13 | 14 | 3 | 0.481 (0.31-0.66) | 0.812 (0.57-0.93) |
...
| technology.internet.url | 44 | 36 | 1 | 8 | 0.973 (0.86-1.00) | 0.818 (0.68-0.90) |

**Headline — column accuracy:** 849/988 = 0.859 (95% CI 0.836-0.880)  

**Macro precision** (mean over labels): 0.875  
**Macro recall** (mean over labels): 0.813  
