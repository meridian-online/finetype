# Gold eval anchor — cksum-guard-gold
...
**Predictions:** `output/attneg-retrain/cksum_predictions_gold.tsv`  
...
| geography.location.country_code | 56 | 53 | 2 | 3 | 0.964 (0.88-0.99) | 0.946 (0.85-0.98) |
...
**Macro precision** (mean over labels): 0.868  
**Macro recall** (mean over labels): 0.826  
