# Gold eval anchor — trim-attneg2-s44-repr
...
**Predictions:** `output/attneg-retrain/trim_predictions_attneg2-s44_repr.tsv`  
...
| geography.location.country | 1 | 1 | 4 | 0 | 0.200 (0.04-0.62) | 1.000 (0.21-1.00) |
...
| representation.identifier.alphanumeric_id | 6 | 1 | 1 | 5 | 0.500 (0.09-0.91) | 0.167 (0.03-0.56) |
...
| representation.numeric.decimal_number | 6 | 5 | 2 | 1 | 0.714 (0.36-0.92) | 0.833 (0.44-0.97) |
| representation.numeric.integer_number | 69 | 67 | 19 | 2 | 0.779 (0.68-0.85) | 0.971 (0.90-0.99) |
...
| representation.text.RESIDUAL | 77 | 53 | 7 | 24 | 0.883 (0.78-0.94) | 0.688 (0.58-0.78) |
...
| technology.cryptographic.hash | 2 | 0 | 0 | 2 | n/a (n/a) | 0.000 (0.00-0.66) |
...
**Headline — column accuracy:** 186/260 = 0.715 (95% CI 0.658-0.767)  

**Macro precision** (mean over labels): 0.855  
**Macro recall** (mean over labels): 0.606  
