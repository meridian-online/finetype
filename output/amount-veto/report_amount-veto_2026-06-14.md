# Gold eval anchor — amount-veto

**Date:** 2026-06-14  
**Gold fixture:** `eval/gold/gold_corpus_v1.tsv` (931 columns)  
**Predictions:** `output/amount-veto/predictions_amount_veto.tsv`  
...
| geography.location.region | 15 | 7 | 11 | 8 | 0.389 (0.20-0.61) | 0.467 (0.25-0.70) |
...
**Headline — column accuracy:** 690/931 = 0.741 (95% CI 0.712-0.768)  
**Macro precision** (mean over labels): 0.709  
**Macro recall** (mean over labels): 0.807  
