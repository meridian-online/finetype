# Gold eval anchor — tierA-base-reframe
...
**Predictions:** `output/sharpen-audit/tierA/pred_base.tsv`  
...
| representation.numeric.integer_number | 193 | 164 | 1 | 29 | 0.994 (0.97-1.00) | 0.850 (0.79-0.89) |
...
**Headline — column accuracy:** 771/927 = 0.832 (95% CI 0.806-0.854)  
**Macro precision** (mean over labels): 0.869  
**Macro recall** (mean over labels): 0.792  
