# Gold eval anchor — url-veto

**Date:** 2026-06-15  
**Gold fixture:** `eval/gold/gold_corpus_v1.tsv` (931 columns)  
**Predictions:** `output/url-veto/predictions_url-veto.tsv`  
...
| representation.numeric.integer_number | 196 | 138 | 1 | 58 | 0.993 (0.96-1.00) | 0.704 (0.64-0.76) |
...
**Headline — column accuracy:** 701/931 = 0.753 (95% CI 0.724-0.780)  
**Macro precision** (mean over labels): 0.717  
