# Gold eval anchor — latdec-s44

**Date:** 2026-06-06  
**Gold fixture:** `eval/gold/gold_eval_anchor.tsv` (240 columns)  
**Predictions:** `output/gold-eval-anchor/predictions_latdec-s44.tsv`  
...
|--------|--------:|---------:|
| A_tight_code_vs_alnum | 30 | 0.300 |
...
|--------|---------------|--------:|---:|---:|---:|----------:|-------:|
| A_tight_code_vs_alnum | representation.identifier.alphanumeric_id | 30 | 9 | 0 | 21 | 1.000 | 0.300 |
...
**Macro recall** (mean over labels): 0.812  
