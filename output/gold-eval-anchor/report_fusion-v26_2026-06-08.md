...
**Predictions:** `output/gold-eval-anchor/predictions_fusion-v26.tsv`  
...
|--------|---------------|--------:|---:|---:|---:|----------:|-------:|
| A_tight_code_vs_alnum | representation.identifier.alphanumeric_id | 30 | 28 | 0 | 2 | 1.000 | 0.933 |
| B_country_vs_categorical | geography.location.country_code | 30 | 30 | 0 | 0 | 1.000 | 1.000 |
...
**Macro recall** (mean over labels): 0.904  
