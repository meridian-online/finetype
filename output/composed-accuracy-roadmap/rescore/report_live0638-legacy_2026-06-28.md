# Gold eval anchor — live0638-legacy

**Date:** 2026-06-28  
**Gold fixture:** `eval/gold/gold_corpus.tsv` (931 columns)  
**Scoring mode:** legacy (categorical is a competing label)  
**Predictions:** `output/composed-accuracy-roadmap/rescore/preds_live0638.tsv`  
...
| representation.numeric.integer_number | 192 | 167 | 1 | 25 | 0.994 (0.97-1.00) | 0.870 (0.81-0.91) |
...
| representation.text.word | 91 | 69 | 6 | 22 | 0.920 (0.84-0.96) | 0.758 (0.66-0.83) |
...
**Headline — column accuracy:** 795/931 = 0.854 (95% CI 0.830-0.875)  
**Macro precision** (mean over labels): 0.866  
**Macro recall** (mean over labels): 0.825  
