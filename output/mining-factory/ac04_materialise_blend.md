...
**2,086 manufactured columns (103,913 values) across 18 types. Categorical columns: 0 (HARD audit: must be zero).**
...
Base: `output/distillation-v3/sherlock_distilled.csv.gz` (102,461 columns) + 2,086 manufactured = 104,547 columns -> `output/mining-factory/sherlock_distilled_mfg.csv.gz`.
...
| `datetime.date.abbreviated_month` | 3,699 | 74 | 3,699 |
| `finance.currency.currency_code` | 149 | 3 | 149 |
| `finance.currency.currency_symbol` | 29 | 1 | 29 |
| `geography.address.postal_code` | 16,954 | 339 | 16,950 |
| `geography.address.street_name` | 92 | 2 | 92 |
| `geography.address.street_suffix` | 11 | 1 | 11 |
| `geography.coordinate.latitude` | 21,478 | 430 | 21,478 |
| `geography.coordinate.longitude` | 29,140 | 583 | 29,140 |
| `geography.location.city` | 27,437 | 549 | 27,437 |
| `geography.location.continent` | 1 | 0 | 0 |
| `geography.location.country` | 18 | 1 | 18 |
| `geography.location.country_code` | 224 | 5 | 224 |
| `geography.location.region` | 3,764 | 76 | 3,764 |
