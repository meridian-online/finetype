# Gold eval anchor — v19-vetofallback

**Date:** 2026-06-12  
**Gold fixture:** `eval/gold/gold_corpus_v1.tsv` (931 columns)  
**Predictions:** `output/gold-corpus/predictions_v19_vetofallback.tsv`  
...
| llm:representation.discrete.categorical | 43 | 0.279 |
...
**Headline — column accuracy:** 662/931 = 0.711 (95% CI 0.681-0.739)  
