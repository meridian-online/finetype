# Gold eval anchor — s44-gold-reframe
...
**Predictions:** `output/representative-accuracy-gate/predictions_s44_gold.tsv`  
...
| external:datetime.date.iso | 9 | 0.111 |
...
| llm:geography.coordinate.longitude | 32 | 0.656 |
...
| tier1:datetime.offset.utc | 35 | 0.800 |
...
| datetime.date.iso | 58 | 52 | 0 | 6 | 1.000 (0.93-1.00) | 0.897 (0.79-0.95) |
| datetime.date.mdy_slash | 4 | 4 | 0 | 0 | 1.000 (0.51-1.00) | 1.000 (0.51-1.00) |
| datetime.epoch.unix_milliseconds | 4 | 4 | 4 | 0 | 0.500 (0.22-0.78) | 1.000 (0.51-1.00) |
| datetime.epoch.unix_seconds | 15 | 10 | 6 | 5 | 0.625 (0.39-0.82) | 0.667 (0.42-0.85) |
...
| datetime.timestamp.sql_standard | 11 | 6 | 3 | 5 | 0.667 (0.35-0.88) | 0.545 (0.28-0.79) |
...
| geography.location.country | 11 | 9 | 2 | 2 | 0.818 (0.52-0.95) | 0.818 (0.52-0.95) |
| geography.location.country_code | 54 | 54 | 3 | 0 | 0.947 (0.86-0.98) | 1.000 (0.93-1.00) |
| geography.location.region | 15 | 11 | 5 | 4 | 0.688 (0.44-0.86) | 0.733 (0.48-0.89) |
...
| identity.commerce.isbn | 18 | 9 | 0 | 9 | 1.000 (0.70-1.00) | 0.500 (0.29-0.71) |
| identity.person.full_name | 1 | 1 | 14 | 0 | 0.067 (0.01-0.30) | 1.000 (0.21-1.00) |
...
| representation.identifier.alphanumeric_id | 62 | 33 | 4 | 29 | 0.892 (0.75-0.96) | 0.532 (0.41-0.65) |
...
| representation.numeric.integer_number | 194 | 161 | 2 | 33 | 0.988 (0.96-1.00) | 0.830 (0.77-0.88) |
| representation.text.RESIDUAL | 129 | 65 | 13 | 64 | 0.833 (0.74-0.90) | 0.504 (0.42-0.59) |
| representation.text.entity_name | 8 | 2 | 8 | 6 | 0.200 (0.06-0.51) | 0.250 (0.07-0.59) |
...
**Headline — column accuracy:** 726/927 = 0.783 (95% CI 0.756-0.809)  
**Macro precision** (mean over labels): 0.744  
**Macro recall** (mean over labels): 0.753  
