# Gold eval anchor — off-code16m-s43
...
**Predictions:** `output/embed-frontier/preds/m2v-code16m-s43_composed.tsv`  
...
| geography.location.city | 24 | 20 | 3 | 4 | 0.870 (0.68-0.95) | 0.833 (0.64-0.93) |
...
| geography.location.country_code | 54 | 51 | 1 | 3 | 0.981 (0.90-1.00) | 0.944 (0.85-0.98) |
| geography.location.region | 15 | 11 | 6 | 4 | 0.647 (0.41-0.83) | 0.733 (0.48-0.89) |
...
| representation.identifier.alphanumeric_id | 62 | 12 | 1 | 50 | 0.923 (0.67-0.99) | 0.194 (0.11-0.31) |
...
| representation.numeric.decimal_number | 94 | 85 | 7 | 9 | 0.924 (0.85-0.96) | 0.904 (0.83-0.95) |
| representation.numeric.integer_number | 194 | 160 | 4 | 34 | 0.976 (0.94-0.99) | 0.825 (0.77-0.87) |
| representation.text.RESIDUAL | 129 | 64 | 15 | 65 | 0.810 (0.71-0.88) | 0.496 (0.41-0.58) |
...
| technology.internet.url | 44 | 37 | 10 | 7 | 0.787 (0.65-0.88) | 0.841 (0.71-0.92) |

**Headline — column accuracy:** 715/931 = 0.768 (95% CI 0.740-0.794)  
**Macro precision** (mean over labels): 0.776  
**Macro recall** (mean over labels): 0.742  
