...
**Predictions:** `output/dual-encoder-native/ac01/p8_noveto.tsv`  
...
| author-open:datetime.component.year | 1 | 1.000 |
...
| external:representation.numeric.decimal_number | 3 | 0.333 |
...
| llm:representation.discrete.categorical | 43 | 0.163 |
| llm:representation.identifier.alphanumeric_id | 37 | 0.432 |
...
| datetime.component.year | 41 | 40 | 26 | 1 | 0.606 (0.49-0.71) | 0.976 (0.87-1.00) |
...
| datetime.epoch.unix_seconds | 15 | 8 | 5 | 7 | 0.615 (0.36-0.82) | 0.533 (0.30-0.75) |
...
| geography.location.city | 24 | 24 | 11 | 0 | 0.686 (0.52-0.81) | 1.000 (0.86-1.00) |
...
| geography.transportation.iata_code | 2 | 1 | 2 | 1 | 0.333 (0.06-0.79) | 0.500 (0.09-0.91) |
...
| identity.person.full_name | 1 | 0 | 9 | 1 | 0.000 (0.00-0.30) | 0.000 (0.00-0.79) |
...
| representation.identifier.alphanumeric_id | 62 | 36 | 2 | 26 | 0.947 (0.83-0.99) | 0.581 (0.46-0.70) |
| representation.identifier.increment | 1 | 0 | 8 | 1 | 0.000 (0.00-0.32) | 0.000 (0.00-0.79) |
...
| representation.numeric.decimal_number | 94 | 62 | 38 | 32 | 0.620 (0.52-0.71) | 0.660 (0.56-0.75) |
| representation.numeric.integer_number | 194 | 122 | 16 | 72 | 0.884 (0.82-0.93) | 0.629 (0.56-0.69) |
| representation.text.RESIDUAL | 129 | 45 | 18 | 84 | 0.714 (0.59-0.81) | 0.349 (0.27-0.43) |
| representation.text.entity_name | 8 | 5 | 34 | 3 | 0.128 (0.06-0.27) | 0.625 (0.31-0.86) |
...
**Headline — column accuracy:** 637/927 = 0.687 (95% CI 0.657-0.716)  
**Macro precision** (mean over labels): 0.713  
**Macro recall** (mean over labels): 0.612  
