# Gold eval anchor — s44-composed-fixed
...
**Predictions:** `output/dual-encoder-native/ac01/pred_s44_composed_fixed.tsv`  
...
|--------|--------:|---------:|
| A_tight_code_vs_alnum | 30 | 0.733 |
...
| geography.location.city | 24 | 24 | 6 | 0 | 0.800 (0.63-0.90) | 1.000 (0.86-1.00) |
...
| geography.location.region | 15 | 10 | 6 | 5 | 0.625 (0.39-0.82) | 0.667 (0.42-0.85) |
| geography.location.state_code | 7 | 6 | 3 | 1 | 0.667 (0.35-0.88) | 0.857 (0.49-0.97) |
| geography.transportation.iata_code | 2 | 2 | 10 | 0 | 0.167 (0.05-0.45) | 1.000 (0.34-1.00) |
...
| representation.identifier.alphanumeric_id | 62 | 29 | 0 | 33 | 1.000 (0.88-1.00) | 0.468 (0.35-0.59) |
...
| representation.numeric.decimal_number | 94 | 77 | 7 | 17 | 0.917 (0.84-0.96) | 0.819 (0.73-0.88) |
| representation.numeric.integer_number | 194 | 162 | 1 | 32 | 0.994 (0.97-1.00) | 0.835 (0.78-0.88) |
| representation.text.RESIDUAL | 129 | 59 | 8 | 70 | 0.881 (0.78-0.94) | 0.457 (0.37-0.54) |
| representation.text.entity_name | 8 | 5 | 14 | 3 | 0.263 (0.12-0.49) | 0.625 (0.31-0.86) |
...
| technology.internet.url | 44 | 42 | 11 | 2 | 0.792 (0.67-0.88) | 0.955 (0.85-0.99) |

**Headline — column accuracy:** 724/927 = 0.781 (95% CI 0.753-0.806)  
**Macro precision** (mean over labels): 0.785  
**Macro recall** (mean over labels): 0.736  
