# Gold eval anchor — offline-composed-reframe
...
**Predictions:** `output/embed-frontier/preds/m2v8m-s44_composed.tsv`  
...
| llm:geography.coordinate.longitude | 32 | 0.875 |
...
| llm:representation.identifier.alphanumeric_id | 37 | 0.703 |
...
| datetime.epoch.unix_seconds | 15 | 10 | 2 | 5 | 0.833 (0.55-0.95) | 0.667 (0.42-0.85) |
...
| geography.location.city | 24 | 24 | 5 | 0 | 0.828 (0.65-0.92) | 1.000 (0.86-1.00) |
...
| geography.transportation.iata_code | 2 | 2 | 9 | 0 | 0.182 (0.05-0.48) | 1.000 (0.34-1.00) |
...
| identity.person.full_name | 1 | 1 | 6 | 0 | 0.143 (0.03-0.51) | 1.000 (0.21-1.00) |
...
| representation.identifier.alphanumeric_id | 62 | 35 | 0 | 27 | 1.000 (0.90-1.00) | 0.565 (0.44-0.68) |
...
| representation.numeric.decimal_number | 94 | 83 | 7 | 11 | 0.922 (0.85-0.96) | 0.883 (0.80-0.93) |
| representation.numeric.integer_number | 194 | 163 | 1 | 31 | 0.994 (0.97-1.00) | 0.840 (0.78-0.89) |
| representation.text.RESIDUAL | 129 | 61 | 10 | 68 | 0.859 (0.76-0.92) | 0.473 (0.39-0.56) |
| representation.text.entity_name | 8 | 6 | 15 | 2 | 0.286 (0.14-0.50) | 0.750 (0.41-0.93) |
...
| technology.internet.url | 44 | 39 | 11 | 5 | 0.780 (0.65-0.87) | 0.886 (0.76-0.95) |

**Headline — column accuracy:** 745/931 = 0.800 (95% CI 0.773-0.825)  
**Macro precision** (mean over labels): 0.762  
**Macro recall** (mean over labels): 0.761  
