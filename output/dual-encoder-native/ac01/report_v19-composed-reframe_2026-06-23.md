# Gold eval anchor — v19-composed-reframe
...
**Predictions:** `output/dual-encoder-native/ac01/pred_v19_composed.tsv`  
...
| geography.location.country | 11 | 9 | 1 | 2 | 0.900 (0.60-0.98) | 0.818 (0.52-0.95) |
| geography.location.country_code | 54 | 53 | 4 | 1 | 0.930 (0.83-0.97) | 0.981 (0.90-1.00) |
| geography.location.region | 15 | 11 | 7 | 4 | 0.611 (0.39-0.80) | 0.733 (0.48-0.89) |
...
| representation.identifier.alphanumeric_id | 62 | 41 | 1 | 21 | 0.976 (0.88-1.00) | 0.661 (0.54-0.77) |
...
| representation.numeric.decimal_number | 94 | 74 | 7 | 20 | 0.914 (0.83-0.96) | 0.787 (0.69-0.86) |
| representation.numeric.integer_number | 194 | 163 | 3 | 31 | 0.982 (0.95-0.99) | 0.840 (0.78-0.89) |
| representation.text.RESIDUAL | 129 | 61 | 13 | 68 | 0.824 (0.72-0.89) | 0.473 (0.39-0.56) |
| representation.text.entity_name | 8 | 5 | 6 | 3 | 0.455 (0.21-0.72) | 0.625 (0.31-0.86) |
...
**Headline — column accuracy:** 739/927 = 0.797 (95% CI 0.770-0.822)  
**Macro precision** (mean over labels): 0.812  
