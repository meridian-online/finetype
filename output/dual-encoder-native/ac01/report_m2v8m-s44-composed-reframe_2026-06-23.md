# Gold eval anchor — m2v8m-s44-composed-reframe
...
**Predictions:** `output/dual-encoder-native/ac01/pred_m2v8m_s44_composed.tsv`  
...
| representation.numeric.integer_number | 194 | 122 | 6 | 72 | 0.953 (0.90-0.98) | 0.629 (0.56-0.69) |
| representation.text.RESIDUAL | 129 | 48 | 21 | 81 | 0.696 (0.58-0.79) | 0.372 (0.29-0.46) |
...
**Headline — column accuracy:** 639/927 = 0.689 (95% CI 0.659-0.718)  
**Macro precision** (mean over labels): 0.732  
