# Gold eval anchor — dual-enc-potion8m-s43-s43

**Date:** 2026-06-23  
**Gold fixture:** `eval/gold/gold_corpus.tsv` (931 columns)  
**Scoring mode:** legacy (categorical is a competing label)  
**Predictions:** `output/dual-encoder-native/ac02-gate/predictions_dual-enc-potion8m-s43.tsv`  
...
| geography.transportation.iata_code | 2 | 2 | 8 | 0 | 0.200 (0.06-0.51) | 1.000 (0.34-1.00) |
...
| representation.text.entity_name | 8 | 6 | 17 | 2 | 0.261 (0.13-0.46) | 0.750 (0.41-0.93) |
| representation.text.plain_text | 42 | 5 | 7 | 37 | 0.417 (0.19-0.68) | 0.119 (0.05-0.25) |
| representation.text.word | 87 | 56 | 10 | 31 | 0.848 (0.74-0.92) | 0.644 (0.54-0.74) |
...
**Headline — column accuracy:** 731/927 = 0.789 (95% CI 0.761-0.814)  
**Macro precision** (mean over labels): 0.826  
