# Gold eval anchor — state-code

**Date:** 2026-06-14  
**Gold fixture:** `eval/gold/gold_corpus_v1.tsv` (931 columns)  
**Predictions:** `output/state-code-promote/predictions_state_code.tsv`  
...
**Headline — column accuracy:** 675/931 = 0.725 (95% CI 0.695-0.753)  
**Macro precision** (mean over labels): 0.695  
