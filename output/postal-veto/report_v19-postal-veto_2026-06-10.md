# Gold eval anchor — v19-postal-veto

**Date:** 2026-06-10  
**Gold fixture:** `eval/gold/gold_corpus_v1.tsv` (931 columns)  
**Predictions:** `output/postal-veto/predictions_v19_postalveto.tsv`  
...
| representation.discrete.categorical | 101 | 39 | 6 | 62 | 0.867 (0.74-0.94) | 0.386 (0.30-0.48) |
| representation.identifier.alphanumeric_id | 54 | 6 | 1 | 48 | 0.857 (0.49-0.97) | 0.111 (0.05-0.22) |
...
**Headline — column accuracy:** 635/931 = 0.682 (95% CI 0.651-0.711)  
**Macro precision** (mean over labels): 0.671  
**Macro recall** (mean over labels): 0.781  
