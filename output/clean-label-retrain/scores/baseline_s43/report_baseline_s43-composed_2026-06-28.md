# Gold eval anchor — baseline_s43-composed
...
**Predictions:** `output/clean-label-retrain/scores/baseline_s43_composed.tsv`  
...
| llm:geography.coordinate.latitude | 30 | 0.900 |
...
| geography.location.country_code | 54 | 50 | 2 | 4 | 0.962 (0.87-0.99) | 0.926 (0.82-0.97) |
| geography.location.region | 15 | 12 | 9 | 3 | 0.571 (0.37-0.76) | 0.800 (0.55-0.93) |
| geography.location.state_code | 7 | 6 | 2 | 1 | 0.750 (0.41-0.93) | 0.857 (0.49-0.97) |
| geography.transportation.iata_code | 2 | 2 | 5 | 0 | 0.286 (0.08-0.64) | 1.000 (0.34-1.00) |
...
| representation.numeric.integer_number | 192 | 166 | 1 | 26 | 0.994 (0.97-1.00) | 0.865 (0.81-0.91) |
| representation.text.RESIDUAL | 120 | 72 | 10 | 48 | 0.878 (0.79-0.93) | 0.600 (0.51-0.68) |
...
**Headline — column accuracy:** 794/931 = 0.853 (95% CI 0.829-0.874)  
**Macro precision** (mean over labels): 0.838  
**Macro recall** (mean over labels): 0.814  
